...
class MethodFactory implements \PhotoCake\Api\Method\MethodFactoryInterface
{
    ...
    public function create($name)
    {
        switch ($name) {
            ...
            case 'users.addPartner': return new Users\AddPartner();
            ...
            case 'users.changePassword': return new Users\ChangePassword();
            ...
            case 'orders.print': return new Orders\ForPrint();
